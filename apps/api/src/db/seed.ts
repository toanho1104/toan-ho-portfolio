...
console.log(`✓ User: ${email} (password synced from SEED_ADMIN_PASSWORD)`);
...
await db
  ...
  .values({
    ...
    name: "Toan Ho",
    title: {
      vi: "Lập trình viên React Native Senior",
...
const sampleProjects = [
  ...
  },
  {
    userId,
    title: {
      vi: "App quản lý sức khỏe cá nhân",
      en: "Personal Health Tracker",
    },
    summary: {
  ...
  },
  {
    userId,
    title: {
      vi: "Thư viện React Native Components",
      en: "RN Component Library",
    },
    summary: {
  ...
  },
  {
    userId,
    title: {
      vi: "Extension VSCode cho React Native",
      en: "VSCode React Native Extension",
    },
    summary: {
